...
export default function PremiumPlan() {
  return (
    <div className="group mx-auto w-full max-w-[800px] rounded-xl border-1 border-black/10 bg-[#033040] p-8 select-none">
      {/* Title */}
      <div className="mb-2 md:flex md:flex-row-reverse items-center justify-between space-x-2">
        <Chip badgeText={"Most Popular"} className="!text-2xl"/>
        <div className="flex gap-2">
          <div className="flex-center h-10 w-10 rounded-full bg-emerald-300">
            <Flame color={"#033040"} />
          </div>
          <h2 className="text-4xl font-semibold text-white">Premium plan</h2>
        </div>
      </div>
      ...
      <div className="mb-8 text-5xl font-medium text-white">
        $59<span className="text-2xl text-gray-300">/visit</span>
      </div>
